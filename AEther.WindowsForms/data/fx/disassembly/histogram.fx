...
Texture2D Histogram0;
Texture2D Histogram1;
    ...
    technique11 t0
    {
        pass p0
        {
            ...
            PixelShader = asm {
                ...
                // Histogram0                        texture  float4          2d             t0      1 
                // Histogram1                        texture  float4          2d             t1      1 
                ...
                #line 13
                add r1.x, -|r0.y|, cb0[0].z  // r1.x <- uv.y
                ...
                #line 17
                  add r1.y, -v1.y, l(1.000000)
                  sample o0.xyzw, r1.yxyy, t0.xyzw, s0
                ...
                #line 21
                  ...
                  sample o0.xyzw, r1.zxzz, t1.xyzw, s0  // o0.x <- v.x; o0.y <- v.y; o0.z <- v.z; o0.w <- v.w
