    ...
    technique11 t0
    {
        pass p0
        {
            ...
            PixelShader = asm {
                ...
                //
                #line 16 "C:\Users\volke\Source\Repos\AEther\AEther.WindowsForms\bin\Debug\net9.0-windows7.0\mandelbrot.fx"
                add r0.xy, v1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
                add r0.zw, r0.xxxy, r0.xxxy  // r0.z <- c.x; r0.w <- c.y
                
                #line 23
                mov r1.xy, r0.zwzz  // r1.x <- z.x; r1.y <- z.y
                mov r1.zw, l(0,0,1.000000,0)  // r1.z <- dz.x; r1.w <- dz.y
                mov r2.x, l(0)  // r2.x <- i
                loop 
                  ige r2.y, r2.x, l(100)
                  breakc_nz r2.y
                ...
                #line 10
                  mul r2.yw, r1.wwwy, r1.yyyy
                  mad r3.x, r1.x, r1.z, -r2.y  // r3.x <- <cmul return value>.x; r3.x <- <cmul return value>.x
                  dp2 r3.y, r1.yxyy, r1.zwzz  // r3.y <- <cmul return value>.y; r3.y <- <cmul return value>.y
                
                #line 26
                  mad r2.yz, r3.xxyx, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, 1.000000, 1.000000, 0.000000)  // r2.y <- dz.x; r2.z <- dz.y
                
                #line 10
                  mad r3.x, r1.x, r1.x, -r2.w
                  dp2 r3.y, r1.xxxx, r1.yyyy
                
                #line 27
                  mad r3.xy, r0.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), r3.xyxx  // r3.x <- z.x; r3.y <- z.y
                
                #line 28
                  dp2 r2.w, r3.xyxx, r3.xyxx
                  sqrt r2.w, r2.w
                  lt r2.w, l(10.000000), r2.w
                  if_nz r2.w
                    mov r1.xy, r3.xyxx  // r1.x <- z.x; r1.y <- z.y
                    mov r1.zw, r2.yyyz  // r1.z <- dz.x; r1.w <- dz.y
                    break 
                  endif   // r3.x <- z.x; r3.y <- z.y; r2.y <- dz.x; r2.z <- dz.y
                ...
                #line 35
                mul r0.x, r0.x, l(-21.640425)
                exp r0.x, r0.x  // r0.x <- l
                
                #line 110 "globals.fxi"
                add r0.x, r0.x, l(0.160000)
                mul r0.x, r0.x, l(0.862069)  // r0.x <- l
                
                #line 102
                mul r0.y, r0.x, r0.x
                mul r0.x, r0.y, r0.x  // r0.x <- <LAB return value>
                
                #line 95
                mul r0.yzw, r0.xxxx, l(0.000000, 0.950000, 1.050000, 0.950000)
                dp3_sat o0.x, l(-0.602824, 1.270823, -0.195529, 0.000000), r0.xyzx
                dp3_sat o0.y, l(0.735608, 0.016275, -0.379961, 0.000000), r0.xzwx
                mul r0.xyz, r0.xxzx, l(0.950000, 1.000000, 1.000000, 0.000000)
                dp3_sat o0.z, l(0.021843, -0.080000, 0.414510, 0.000000), r0.xyzx
                
                #line 41 "C:\Users\volke\Source\Repos\AEther\AEther.WindowsForms\bin\Debug\net9.0-windows7.0\mandelbrot.fx"
                mov o0.w, l(1.000000)
                ret 
